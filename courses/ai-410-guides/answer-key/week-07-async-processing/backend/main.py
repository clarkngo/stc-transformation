"""
AI 410 — Week 7 answer key: Asynchronous Data Processing

Chat (with RAG + guardrails) is unchanged from Weeks 4-6. Document
upload now enqueues a background job instead of running inline, and
a status endpoint reports on it.
