"""
AI 410 — Week 8 answer key: Mobile Client & Push Notifications

Async ingestion (Week 7), device registration, and the Week 8 push
notification on job completion (jobs.py) are all solved. The mobile/
app requests notification permission and registers the device too.
"""
